...
@implementation CategoryListMainVC
...
- (void)tableViewSelectionDidChange:(NSNotification *)notification
{
    ...
    if (index >= 0)
    {
        ...
        NSViewController *userEdit = [sb instantiateControllerWithIdentifier:@"CategoryEditVC"];
...
- (IBAction)AddCategoryButtonOnClick:(id)sender
{
    NSStoryboard *sb = [self storyboard];
    id animator = [[MyCustomAnimator alloc] init];
    NSViewController *userEdit = [sb instantiateControllerWithIdentifier:@"CategoryAddVC"];
